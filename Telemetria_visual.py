...
class painel_telemetria(QMainWindow):
    def __init__(self):
        ...
        self.grafico_rpm.setYRange(0, 15000) 
        ...
        # --- NOVA VARIÁVEL: Controle da Volta Atual ---
        self.numero_volta = 1
    ...
    def atualizar_tudo(self):
        ...
        # --- SALVANDO A VOLTA E O TEMPO RELATIVO ---
        # Agora salvamos o Número da Volta e os Segundos Decorridos
        self.historico_completo.append([self.numero_volta, round(tempo_decorrido, 3), rpm, acel, freio])

        if tempo_decorrido > 10.0:
            self.fechar_volta(tempo_decorrido)

    def reiniciar_tempos(self, checked = None):
        self.numero_volta = 1 # Reseta a volta
        self.inicio_volta = time.time()
        self.melhor_tempo_s = None
    ...
    def salvar_telemetria(self, checked = None):
        ...
        try:
            with open(caminho_completo, mode="w", newline='') as arquivo:
                ...
                escritor.writerow(["Volta", "Tempo_Volta", "RPM", "Acelerador", "Freio"])
    ...
    def fechar_volta(self, tempo_final):
        ...
        self.numero_volta += 1 # Incrementa a volta
        self.inicio_volta = time.time()
